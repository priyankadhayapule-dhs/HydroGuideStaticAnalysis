...
public class SerialFrameCRC {
  private static final int[] crc_table = new int[] { // size of 256
  ...
  private static final int CRC_OF_STX = 0xABFF;
  private static final int FINAL_XOR = 0xFFFF;
  private int runningCRC = 0;
  ...
  public void reset() {
    runningCRC = xor(CRC_OF_STX, FINAL_XOR);
  }

  public int read() {
    return xor(runningCRC, FINAL_XOR);
  }

  public void put(final byte by) {
    runningCRC = xor(crc_table[(runningCRC ^ by) & 0x00FF], (runningCRC >> 8) & 0xFF);
  }

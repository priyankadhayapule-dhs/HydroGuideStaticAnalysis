...
#define TER_UMGR_PUCK_EXISTS		0x4001000B
// Thor Only: This operation is only available on the Thor Tablet
#define TER_UMGR_THOR_ONLY		0x4001000C

//
// Dau Hardware
//
// Power Error: The power supply it outside of its defined parameters
...
// Thermal
//
// DauThermal: The Dau is too hot
#define TER_THERMAL_DAU		0x40050001
// TabletThermal: The tablet is too hot
